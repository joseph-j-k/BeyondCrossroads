  ...
  <body class="skin-yellow">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="HomePage.php" class="logo"><b>Student</b></a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <img src="../Assets/Files/Student_file/Photo/<?php echo $data['student_photo']?>" class="img-circle" alt="User Image" />
            </div>
          <div class="pull-left image">
            </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="ViewAttandance.php">
                <i class="fa fa-table"></i> <span>Attendance</span>
              </a>
            </li>
            <li class="active treeview">
              <a href="ViewInternalMark.php">
                <i class="fa fa-pie-chart"></i> <span>Internal Mark</span>
              </a>
            </li>
            <li class="active treeview">
              <a href="Snotes.php">
